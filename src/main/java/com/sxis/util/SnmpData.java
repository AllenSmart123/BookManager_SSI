...
public class SnmpData {
  ...
  public static void setPDU(String ip,String community,String oid) throws IOException
  {
    ...
    Snmp snmp = null;
    PDU pdu = new PDU();
    pdu.add(new VariableBinding(new OID(oid),new OctetString("INTEGER: direct(3)")));
    pdu.setType(PDU.SET);
  ...
  public static void main(String[] args) {
    //snmpGet("192.168.212.66", "public", ".1.3.6.1.2.1.4.21.1.8.10.82.64.0");
    /*try {
      setPDU( "192.168.212.66", "public", ".1.3.6.1.2.1.4.21.1.8.10.82.64.0" );
    }catch( Exception e ){
      e.printStackTrace();
    }*/
    System.out.println(new java.util.Date(1488816555437L));
}
